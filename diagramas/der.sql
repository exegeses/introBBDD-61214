...
-- Schema introDB61214
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `introDB61214` DEFAULT CHARACTER SET utf8 ;
USE `introDB61214` ;

-- -----------------------------------------------------
-- Table `introDB61214`.`marcas`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `introDB61214`.`marcas` (
...
-- -----------------------------------------------------
-- Table `introDB61214`.`categorias`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `introDB61214`.`categorias` (
...
-- -----------------------------------------------------
-- Table `introDB61214`.`productos`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `introDB61214`.`productos` (
  ...
  CONSTRAINT `fk_productos_marcas`
    FOREIGN KEY (`idMarca`)
    REFERENCES `introDB61214`.`marcas` (`idMarca`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_productos_categorias1`
    FOREIGN KEY (`idCategoria`)
    REFERENCES `introDB61214`.`categorias` (`idCategoria`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
